    ...
    <div class="center">
        ...
        <div class="section">
            <h5>Donate Class Gift</h5>
                ...
                <button onclick="window.location='<?php echo e(url("choice")); ?>'" class="btn waves-effect waves-light" type="submit" name="action1" value="options">
                    Submit
        ...
        <div class="section">
            <h5>Donate through SAIL portal</h5>
                    ...
                    <button onclick="window.location='<?php echo e(url("donate")); ?>'" class="btn waves-effect waves-light" type="submit" name="action" value="options">Submit
                        <i class="material-icons right">send</i>
                    </button>
